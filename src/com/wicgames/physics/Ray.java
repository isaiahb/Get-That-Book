...
public class Ray {
	...
	boolean hit;			//Whether the ray hit something in the distance it traveled or not
	Vector2 endPosition;	//if it hit something this 
	Vector2 startPosition;	//the position to start casting the ray
	...
	public static ArrayList<Vector2> line(int x, int y, int x2, int y2) {
