...
public abstract class Constraint {
	...
	public static void created (Constraint constraint) {
		Scene.currentScene.constraints.add(constraint);
	}
	...
	public static void update(ArrayList<Constraint> bodies) {
		for (int i = 0; i < bodies.size(); i++) {
			bodies.get(i).update();
		}
	}
	public static void draw(ArrayList<Constraint> constraint, Graphics2D graphics2D) {
		for (int i = 0; i < constraint.size(); i++) {
			constraint.get(i).draw(graphics2D);
		}
	}
